...
class ClassificationCNN(nn.Module):
    ...
    def __init__(self, input_dim=(3, 32, 32), num_filters=32, kernel_size=7,
        ...
        conv1 = nn.Conv2d(channels, num_filters, kernel_size, stride_conv, pads)
        conv1.weight.data *= weight_scale
        ...
        self.layer2 = nn.Sequential(
            nn.Linear(num_filters*int(height/2)*int(width/2), hidden_dim),
